...
export default function FirstPage() {
  ...
  return (
    <div ref={containerRef} className="h-screen relative overflow-hidden">
      ...
      <motion.img
        src="JWR2.jpg"
        className="object-cover h-full absolute top-0 rounded-lg"
      ...
      <div className="w-[55%] h-full grid grid-cols-7 grid-rows-7 px-5">
        <div className="row-start-2 col-span-6 flex items-center">
            <p className="text-white font-black text-[3.7vw] leading-tight">
                "Hilariously Haunting"
            </p>
        </div>

        <div className="row-span-4 col-span-7 flex items-center justify-center">
        ...
        <div className="col-start-4 col-span-4 flex flex-col items-end">
            <p className="text-white font-black text-[2.7vw]">
                DIRECTED BY. 
            </p>
